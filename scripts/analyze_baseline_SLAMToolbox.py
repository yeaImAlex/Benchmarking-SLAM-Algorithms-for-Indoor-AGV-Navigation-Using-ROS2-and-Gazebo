...
def get_bag_data(bag_path, topic_name):
    ...
    while reader.has_next():
        ...
        if topic == topic_name:
            ...
            # --- MODIFIED: Logic for SLAM Toolbox Pose ---
            # SLAM Toolbox typically publishes localization on '/pose'
            if topic_name == '/pose': 
...
def plot_and_calculate(parent_dir):
    ...
    slam_topic = "/pose"  # CHANGED from /amcl_pose
    ...
    plt.plot(df_slam['x'], df_slam['y'], 'g-', label='Estimated Path (SLAM Toolbox)', linewidth=2) # Changed color to green
    ...
    # Updated Title
    plt.title(f'SLAM Toolbox vs Ground Truth\nRMSE: {rmse:.4f} m | Time: {completion_time}')
    ...
    save_path = os.path.join(parent_dir, 'slam_toolbox_graph.png')
    plt.savefig(save_path)
    print(f"Graph saved to: {save_path}")
    plt.show()

if __name__ == "__main__":
    # Update this path to your SLAM Toolbox bag folder
    PARENT_DIR = "/home/ser/FYP/ros2_ws/src/fyp_bot/fyp_bot/SLAMToolbox_bag_20260115_160321" 
